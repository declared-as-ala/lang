// src/app/features/admin/fillblank/fillblank.component.ts
import {
  Component,
  OnInit,
  Signal,
...
import { FillBlankService, FillBlank } from "./fillblank.service";
  ...
  template: `
    ...
    <div class="space-y-6 p-4">
      ...
      <div class="flex items-center justify-between">
        <h2 class="text-2xl font-semibold">Fill-in-the-Blank Questions</h2>
        ...
        <table class="min-w-full bg-white rounded-lg overflow-hidden shadow">
          ...
          <tbody>
            ...
            >
              ...
              <td class="td truncate max-w-[300px]" title="{{ item.sentence }}">
                {{ item.sentence }}
              </td>
      ...
      >
        ...
        <form [formGroup]="form" (ngSubmit)="onSubmit()" class="space-y-4">
          <div class="grid grid-cols-1 gap-4">
            <input
              class="input"
              placeholder="Sentence (use ___ for the blank)"
...
export class FillBlankComponent implements OnInit {
  ...
  constructor(private service: FillBlankService, private fb: FormBuilder) {}
  ...
  onSubmit() {
    const payload: Partial<FillBlank> = {
